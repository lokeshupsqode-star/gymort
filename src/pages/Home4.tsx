        ...
        <>
                ...
                <div className="container">
                    <div className="row home4-exercise-section-row">
                        <div className="col-xxl-6 col-lg-6">
                            <img src="/images/about/home4About.jpg" alt="smarter_exercise_img" className='home4About blur-in' />
                        </div>
                        <div className="col-xxl-6 col-lg-6">
                            <p className="sub-heading-section split-text left-text-home4">Exercise Smarter, Feel Better. Live Longer.</p>
                            <h2 className="section-heading split-text ultrices">BECOME YOUR STRONGEST SELF</h2>
                            <div className="smarter_exercise_detail">
                                <p className="heding-sub-discrib left-text-home4 pt-0">
                                    Pellentesque porta pretium pellentesque ultrices ultricies eu lectus. Justo vulputate commodo elementum nulla in gravida blandit. Scelerisque venenatis id id arcu nunc tristique rhoncus sit leo. Nunc tincidunt id dignissim nunc amet dui orci pulvinar Volutpat pharetra ut.
                                </p>
                                <p className="heding-sub-discrib left-text-home4">
                                    Laoreet lectus urna amet sem viverra. In eu diam nisi viverra lobortis pretium. Massa eget urna ipsum lorem pellentesque vivamus. Euismod in libero eget vel sed. Ultrices urna commodo pellentesque risus volutpat eu erat.</p>
                                <Link to="/our-program" className="btn-main anim anim--3 home4Hero-btn">
                                    <span className="btn-quote black-btn-quote">Let’s Train Now</span>
            ...
            <section className='home4myProgram-section'>
                <div className='container'>
                    ...
                    <h2 className="section-heading split-text bugt">THE BEST WAY TO START YOUR DAY</h2>
                    {/* <MyProgram /> */}
                </div>
            </section>
            {/* ==================== Counter Section ==================== */}
